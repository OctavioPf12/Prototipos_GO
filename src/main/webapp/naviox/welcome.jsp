...
In Prototipocuatro-labels_en.properties:
Prototipocuatro=My application
Prototipocuatro[description]=My application does this and that

In Prototipocuatro-messages_en.properties:
